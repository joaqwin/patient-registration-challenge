...
2. Go to **Email Testing → Inboxes** and open (or create) an inbox.
3. Click **SMTP Settings** and select **Integration: SMTP**.
4. Copy the **Host**, **Port**, **Username**, and **Password** values into your `.env`.
